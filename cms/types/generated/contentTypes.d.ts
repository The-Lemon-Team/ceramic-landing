...
export interface ApiAboutAuthorAboutAuthor extends Struct.SingleTypeSchema {
  collectionName: 'about_authors';
  info: {
    description: '\u0411\u043B\u043E\u043A \u00AB\u041E\u0431 \u0430\u0432\u0442\u043E\u0440\u0435\u00BB \u2014 \u0437\u0430\u0433\u043E\u043B\u043E\u0432\u043E\u043A, \u0430\u0432\u0442\u043E\u0440, \u0431\u0438\u043E\u0433\u0440\u0430\u0444\u0438\u044F, \u0444\u043E\u0442\u043E';
  ...
  attributes: {
    ...
    sectionLabel: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'\u041C\u0430\u0441\u0442\u0435\u0440'>;
    sectionTitle: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'\u041E\u0431 \u0430\u0432\u0442\u043E\u0440\u0435'>;
...
export interface ApiArtsThemeArtsTheme extends Struct.CollectionTypeSchema {
  collectionName: 'arts_themes';
  info: {
    description: '\u0422\u0435\u043C\u044B \u0433\u0430\u043B\u0435\u0440\u0435\u0438 \u00AB\u0417\u0430\u0440\u0438\u0441\u043E\u0432\u043A\u0438 \u0438 \u0430\u0440\u0442\u044B\u00BB';
    displayName: 'Arts Theme';
    pluralName: 'arts-themes';
    singularName: 'arts-theme';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::arts-theme.arts-theme'
    > &
      Schema.Attribute.Private;
    media: Schema.Attribute.Component<'shared.media-item', true>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiDirectionsDirection extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    title: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'\u041A\u0430\u043A \u0434\u043E\u0431\u0440\u0430\u0442\u044C\u0441\u044F'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'\u0413\u0410\u041B\u0415\u0420\u0415\u042F'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text & Schema.Attribute.Required;
    dimensions: Schema.Attribute.String & Schema.Attribute.DefaultTo<'\u2014'>;
    finish: Schema.Attribute.String & Schema.Attribute.DefaultTo<'\u2014'>;
...
export interface ApiSiteConfigSiteConfig extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    heroCtaLabel: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'\u041F\u0440\u043E\u0441\u043C\u043E\u0442\u0440\u0435\u0442\u044C \u043A\u043E\u043B\u043B\u0435\u043A\u0446\u0438\u044E'>;
    heroMotto: Schema.Attribute.Text &
      Schema.Attribute.DefaultTo<'\u041A\u0435\u0440\u0430\u043C\u0438\u0447\u0435\u0441\u043A\u0438\u0435 \u0438\u0437\u0434\u0435\u043B\u0438\u044F, \u0441\u043E\u0437\u0434\u0430\u043D\u043D\u044B\u0435 \u0441 \u0434\u0443\u0448\u043E\u0439 \u0438 \u0442\u0435\u043F\u043B\u043E\u043C \u0432 \u043D\u0430\u0448\u0435\u0439 \u0441\u0442\u0443\u0434\u0438\u0438.'>;
    heroSubTitle: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'\u041A\u0435\u0440\u0430\u043C\u0438\u043A\u0430 \u0421\u0430\u043D\u043A\u0442-\u041F\u0435\u0442\u0435\u0440\u0431\u0443\u0440\u0433\u0430'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    siteName: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Ceramic\u2022Loop'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTelegramPostTelegramPost
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['Update', 'Workshop', 'Process', 'Announcement']
    > &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::arts-theme.arts-theme': ApiArtsThemeArtsTheme;
      'api::directions.direction': ApiDirectionsDirection;
